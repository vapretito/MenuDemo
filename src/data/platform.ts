...
export const planCatalog: PlanRecord[] = [
  ...
  },
  {
    ...
    productLimit: 40,
    features: [
      "Plan interno para prueba real",
      "Pago real de bajo monto",
      "Validación de Mercado Pago producción",
      "No ofrecer comercialmente",
    ],
  },
];
...
const sushiDemo: RestaurantRecord = {
  ...
  name: "Nori Lab",
  slug: "nori-lab",
  subdomain: "nori-lab.menui.online",
    dnsStatus: "pending",
